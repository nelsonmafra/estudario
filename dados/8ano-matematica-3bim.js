...
{ id:"r2", emoji:"💸", nome:"Rodada 2 — Porcentagem com equações",
  ...
  questoes:[
    ...
    {p:"Qual é a grande estratégia desta aula para resolver problemas de porcentagem?", alt:["Escrever a porcentagem como decimal e montar uma equação com o valor desconhecido","Chutar valores até acertar","Sempre dividir por 100 no final","Usar régua e compasso"], c:0, exp:"Transformar 105% em 1,05 (ou 85% em 0,85) e montar a equação 1,05x = valor pago é o método que resolve qualquer problema desses."},
