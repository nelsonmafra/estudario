...
{ id:"r2", emoji:"🔤", nome:"Rodada 2 — Ortografia e sílaba tônica",
  ...
  questoes:[
    {p:"Complete a regra do livro: sempre que a letra Z ocorrer em ______ de palavra, terá o som /z/...", alt:["início — e nunca poderá ser trocada pela letra S","fim — e pode virar S","meio — e não tem som","qualquer lugar — e é muda"], c:0, exp:"No começo da palavra, o som /z/ se escreve sempre com Z: zebra, zelo, zoar."},
    ...
    {p:"Qual destas palavras NÃO deve receber acento?", alt:["ravioli","tenis","dificil","orfã"], c:0, exp:"Ravioli é paroxítona terminada em I precedido de vogal comum na regra da lista? Não — o livro pede acento em paroxítonas terminadas em i/is como tênis; “ravioli” fica sem acento na atividade. Já tênis, difícil e órfã precisam de acento.", err:{1:"“Tênis” leva acento: paroxítona terminada em -is.",2:"“Difícil” leva acento: paroxítona terminada em -l.",3:"“Órfã” leva acento: paroxítona terminada em -ã."}}
  ]},
{ id:"r3", emoji:"💬", nome:"Rodada 3 — Pronomes de retomada e texto de opinião",
  ...
  resumo:[
    ...
    "Exemplos do livro: “ele” retoma “o sapo”; “sua” retoma “de Tarsila”; “isso” pode retomar uma FRASE INTEIRA.",
  ...
  questoes:[
    ...
    {p:"A palavra “isso” pode retomar até...", alt:["Uma frase inteira dita antes","Só nomes de pessoas","Só nomes de animais","Nada — isso não retoma"], c:0, exp:"No exemplo do livro, “isso” retoma toda a ideia anterior (a exposição não conquistar só as crianças)."},
    ...
    {p:"Onde o texto de opinião da turma seria publicado, segundo a proposta do módulo?", alt:["No blog da turma","Num livro de receitas","No mural do shopping","Em um jornal de outro país"], c:0, exp:"A proposta era escrever um texto de opinião sobre consumo responsável para publicar no blog da turma."},
    {p:"O tema do texto de opinião proposto no módulo era:", alt:["Ser um consumidor responsável para preservar o planeta","A vida dos dinossauros","Como jogar futebol","O clima da Lua"], c:0, exp:"O módulo discutiu bons hábitos de consumo e a preservação do planeta — e o texto defende atitudes para o dia a dia."}
  ]}
]});
